...
def build_discriminator(input_shape=(128, 128,), verbose=True):
    """
...
def build_dc_discriminator(input_shape=(128, 128, 1), verbose=True):
    """
...
def build_conditional_discriminator(input_shape=(128, 128, 1),
...
def build_critic(input_shape=(128, 128, 1), verbose=True):
    """
...
def build_generator(z_dim=100, output_shape=(128, 128), verbose=True):
    """
...
def build_conditional_generator(z_dim=100, output_shape=(128, 128, 1),
                                num_classes=10, verbose=True):
    """
    Utility method to build a MLP generator
    Parameters:
